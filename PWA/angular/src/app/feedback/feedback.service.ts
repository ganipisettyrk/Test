...
export class FeedbackService {
	...
	constructor(private httpRequest: HttpRequestService, private deviceService: DeviceDetectorService) { }

	submitFeedback(formGroup): Observable<any> {

		let params = {
			'name': formGroup.value.nameModel,
			'email': formGroup.value.emailModel,
			'message': formGroup.value.feedbackModel,
			'category': "MWeb",
