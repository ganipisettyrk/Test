...
export class AppComponent {
  ...
  loginDestinationUrl: string = '/home';
  ...
  ngOnInit(): void {
    ...
    this.router.events.forEach((event: NavigationEvent) => {
      if (event instanceof NavigationStart) {
        ...
        this.appService.isBannerEnabled(this.navigationUrl).subscribe(
          res => {
  ...
  private getUpdatedUrl(url: string): string {
    ...
    this.commonService.checkAndUpdateStoreId().subscribe(
      storeRes => {
        ...
        if (null != landingUrl) {
          ...
          landingUrl = this.getUpdatedUrl(landingUrl);
        }
  ...
  private showLogin(landingUrl: string): void {
    if (null != landingUrl) {
      this.loginDestinationUrl = landingUrl;
    }
    else {
      this.loginDestinationUrl = "home";
    }
    sessionStorage.setItem("loginDestinationUrl", this.loginDestinationUrl);
