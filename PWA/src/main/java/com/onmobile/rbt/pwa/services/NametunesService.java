...
public class NametunesService implements WebConstants {
	...
	public String createNametunes(String newNameTune, String type, HttpServletRequest request, HttpSession session, Device device)
		...
		try {
			...
			createNameTunes1(session, nameTunesBeanStr, newNameTune, storeId, token);
	...
	private String createNameTunes1(HttpSession session, String nameTunesBeanStr, String newNameTune, String storeId,
