...
public class ChartService implements WebConstants {
	...
	public String populateDynamicChartItems(HttpServletRequest request, HttpSession session, Device device,
			String chartId, String offset, String maxItems, String contentLanguage) throws StoreServerException {
	...
	public String getChartItems(HttpServletRequest request, HttpSession session, Device device, String chartId,
			String offset, String maxItems, String contentLanguage, String browsingLanguage)
		...
		Integer maxCount = Integer.parseInt(maxItems);
		url = url.replace("%MAX_COUNT%", maxCount.toString());
		url = url.replace("%OFFSET%", offset);
		url = webUtils.getUpdatedVoltronUrl(session, url);
	...
	public String getContentRecommendations(String contentId, String albumName, String offset, String maxCount,
		...
		try {
			recommendations = voltronInterface.hitVoltronAPI(session, url, REQUEST_GET, null, String.class);
	...
	public String getMultiContentRecommendations(String contentIds, String offset, String maxCount, String albumName,
			String contentLanguage, HttpServletRequest request, HttpSession session, Device device)
			throws StoreServerException {
