...
public class ContentService implements WebConstants {
	...
	public String getContentMetadata(String contentId, String contentType,
			String paramType, String paramSubtype, String browsingLanguage,
			String extMode, String showAvailability, HttpServletRequest request, HttpSession session,
